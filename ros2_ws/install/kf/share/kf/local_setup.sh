...
: ${AMENT_CURRENT_PREFIX:="/workspaces/mavlab/ros2_ws/install/kf"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kf/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kf/environment/path.sh"
