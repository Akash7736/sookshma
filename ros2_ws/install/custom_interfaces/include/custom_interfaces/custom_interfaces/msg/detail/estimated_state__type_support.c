...
#include <stddef.h>
#include "custom_interfaces/msg/detail/estimated_state__rosidl_typesupport_introspection_c.h"
...
void custom_interfaces__msg__EstimatedState__rosidl_typesupport_introspection_c__EstimatedState_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  custom_interfaces__msg__EstimatedState__init(message_memory);
}

void custom_interfaces__msg__EstimatedState__rosidl_typesupport_introspection_c__EstimatedState_fini_function(void * message_memory)
{
...
static rosidl_typesupport_introspection_c__MessageMember custom_interfaces__msg__EstimatedState__rosidl_typesupport_introspection_c__EstimatedState_message_member_array[6] = {
  {
    ...
    offsetof(custom_interfaces__msg__EstimatedState, u),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__EstimatedState, v),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__EstimatedState, r),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__EstimatedState, x),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__EstimatedState, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_interfaces__msg__EstimatedState, heading),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers custom_interfaces__msg__EstimatedState__rosidl_typesupport_introspection_c__EstimatedState_message_members = {
  ...
  custom_interfaces__msg__EstimatedState__rosidl_typesupport_introspection_c__EstimatedState_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t custom_interfaces__msg__EstimatedState__rosidl_typesupport_introspection_c__EstimatedState_message_type_support_handle = {
  0,
  &custom_interfaces__msg__EstimatedState__rosidl_typesupport_introspection_c__EstimatedState_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, custom_interfaces, msg, EstimatedState)() {
  ...
  return &custom_interfaces__msg__EstimatedState__rosidl_typesupport_introspection_c__EstimatedState_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
