...
#include "custom_interfaces/msg/detail/estimated_state__rosidl_typesupport_fastrtps_c.h"
...
static uint32_t _EstimatedState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_interfaces__msg__EstimatedState(
...
static size_t _EstimatedState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_interfaces__msg__EstimatedState(
