    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'custom_interfaces.msg.Actuator')
            logger.debug(
...
class Actuator(metaclass=Metaclass_Actuator):
    ...
    def __init__(self, **kwargs):
        ...
        self.propeller = kwargs.get('propeller', float())
    ...
    def __eq__(self, other):
        ...
        if self.rudder != other.rudder:
            return False
        if self.propeller != other.propeller:
            return False
    ...
    def propeller(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'propeller' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'propeller' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
