...
#include "custom_interfaces/msg/detail/estimated_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_interfaces::msg::EstimatedState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_interfaces::msg::EstimatedState & ros_message)
{
  // Member: u
  cdr >> ros_message.u;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_interfaces::msg::EstimatedState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_interfaces::msg::EstimatedState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_interfaces::msg::EstimatedState *>(
    untyped_ros_message);
...
{
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_EstimatedState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_interfaces, msg, EstimatedState)() {
  return &custom_interfaces::msg::typesupport_fastrtps_cpp::_EstimatedState__handle;
}
